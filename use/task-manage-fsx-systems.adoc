...
NetApp Consoleシステム ページから FSx for ONTAPシステムを開くと、 NetAppワークロードが表示されます。  Workloads は、業界のベストプラクティスを使用して、 Amazon FSx for NetApp ONTAPで主要なワークロードを設計、セットアップ、運用するインテリジェントな最適化お​​よび自動化サービスです。
...
バックアップと災害復旧をサポートするためにデータを複製します。FSx for ONTAPファイル システムとCloud Volumes ONTAP間のデータ レプリケーションは、 NetApp Replication を使用して実行できます。レプリケーションを使用すると、 ONTAPストレージ システム間でデータを複製して、クラウドまたはクラウド間のバックアップと災害復旧をサポートできます。

link:https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["NetApp Replicationを使い始める"^]

2 つの FSx for ONTAPファイル システム間、およびオンプレミスのONTAPシステムと FSx for ONTAPファイル システム間のデータ レプリケーションは、 NetApp Consoleのシステム ページから実行できます。

.開始する前に
始める前に次の点を考慮してください。

* 2 つの FSx for ONTAPファイル システム間、またはオンプレミスのONTAPシステムと FSx for ONTAPファイル システム間でデータを複製するには、ファイル システムに接続できるコンソール エージェントを選択するか、ファイル システムを入力してリンクを関連付ける必要があります。
* 使用可能、作成済み、または誤って構成された状態以外のボリューム、およびONTAPバージョンに互換性がない場合は、レプリケーションはサポートされません。


.手順
. NetApp Consoleシステム ページから、ソースの FSx for ONTAPファイル システムまたはオンプレミスのONTAPシステムをターゲットの FSx for ONTAPファイル システムの上にドラッグし、[レプリケーション] を選択します。
