...
バックアップと災害復旧をサポートするためにデータを複製します。 FSx for ONTAPファイル システムとCloud Volumes ONTAP間、または FSx for ONTAPファイル システムとオンプレミスのONTAPシステム間のデータ レプリケーションは、 NetApp Replicationを使用して実行できます。レプリケーションを使用すると、 ONTAPストレージ システム間でデータを複製して、クラウドまたはクラウド間のバックアップと災害復旧をサポートできます。

link:https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["NetApp Replicationを使い始める"^]

2 つの FSx for ONTAPファイル システム間のデータ レプリケーションは、 NetApp Consoleシステム ページから実行できます。
...
.手順
. NetApp Consoleシステム ページから、ソースの FSx for ONTAPファイル システムをターゲットの FSx for ONTAPファイル システムの上にドラッグし、[レプリケーション] を選択します。
